 ...
 * mensagens sobre sockets usando o protocolo TCP. A transferência de dados é baseada em objectos, um objecto de cada
 * vez.
 */
...
public class ServerCom {
    ...
    /**
     * Estabelecimento do serviço. Instanciação de um socket de escuta e sua associação ao endereço da máquina local e
     * ao port de escuta públicos.
     */
    ...
    /**
     * Processo de escuta. Criação de um canal de comunicação para um pedido pendente. Instanciação de um socket de
     * comunicação e sua associação ao endereço do cliente. Abertura dos streams de entrada e de saída do socket.
     *
